<?php
    // Author: Dominic DiModugno
    // Email: d.dimodugno@acilab.com
...
<body>
    <form method="post" action="post.php" class="container">
        ...
        <ul class="progressBar postProgressBar">
            ...
            <li class="active" id="organization">
                <div>
        ...
        <div class="form-group finished form-active">            
            <div class="row">
