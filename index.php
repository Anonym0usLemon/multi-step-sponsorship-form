...
<body>
    <form method="post" action="post.php" class="container">
        ...
        <div class="form-group policy form-active">
            <div class="row">
                <h2 class="form-title">ACI Sponsorship Policies and Expectations</h2>
            ...
            <div class="">
                ...
                <h3>General Guidelines for Maximum Sponsorship</h3>
                <p><strong>Please note:</strong> if other programs are going on at the same time as the program you are requesting sponsorship for, the estimated sponsorship shown in the chart below may be lowered by 50%.</p>
                <br>
                <p>ACI's sponsorship is based in part upon the number of attendees the Organization requesting the sponsorship expects to attend the speaker's program. The amounts shown above are strictly guidelines and not guaranteed until the Organization requesting sponsorship receives a signed copy of the Request for Sponsorship, from ACI, with the amount of sponsorship to be awarded.</p>

                <table>
                    <tr>
                        <th>Estimated attendance in the in person program</th>
                        <td>15-50</td>
                        <td>51-125</td>
                        <td>126-400</td>
                        <td>401-600</td>
                    ...
                    <tr>
                        <th>Estimated attendance in the virtual program</th>
                        <td>51-125</td>
                        <td>126-400</td>
                        <td>401-600</td>
                        <td></td>
        ...
        <div class="form-group">
            <div class="row">
                <h2 class="form-title">Organization Info</h2>
        ...
        <div class="form-group">            
            <div class="row">
                <h2 class="form-title">How can we contact you?</h2>
